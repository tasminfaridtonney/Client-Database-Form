...
<?php
          ...
          if(isset($_POST['delivery_date'])) $delivery_date = $_POST['delivery_date'];
           ...
           if(isset($_POST['full'])) $full = $_POST['full'];
            ...
            $sql = "INSERT INTO data_store (project_name,clint_address,clint_req,s_time,delivery_target,project_correction,completed_date,project_drop,pro_restart,drop_reason,delivery_date,archi_name,engin_name,challenge_project,supervision,construction,quality_control,major_deision,project_management,one_quater,one_half,three_quarter,full)
            VALUES ( '$project_name','$clint_address', '$clint_req','$s_time','$delivery_target', '$project_correction','$completed_date','$project_drop','$pro_restart','$drop_reason','$delivery_date','$archi_name','$engin_name','$challenge_project','$supervision','$construction','$quality_control','$major_deision','$project_management','$one_quater','$one_half','$three_quarter','$full')";
    	...
    	<div class="col-sm-10">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                <div class="heading text-center font-weight-bolder">
                   <h1>Client Database Form</h1> 
                </div>
